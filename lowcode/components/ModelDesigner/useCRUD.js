...
const useCRUD = (modelId, options = {}) => {
  ...
  // Create
  const create = useCallback(async (item, hooks) => {
    setLoading(true)
    setError(null)
    try {
  ...
  // Read all
  const readAll = useCallback(async (queryOptions, hooks) => {
    setLoading(true)
    setError(null)
    try {
  ...
  // Read by ID
  const readById = useCallback(async (id, hooks) => {
    setLoading(true)
    setError(null)
    try {
  ...
  // Update
  const update = useCallback(async (id, item, hooks) => {
    setLoading(true)
    setError(null)
    try {
  ...
  // Delete
  const remove = useCallback(async (id, hooks) => {
    setLoading(true)
    setError(null)
    try {
  ...
  // Batch create
  const batchCreate = useCallback(async (items, hooks) => {
    setLoading(true)
    setError(null)
    try {
